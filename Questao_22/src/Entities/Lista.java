...
public class Lista {
	...
	public Bloco addElemento(Aluno valor, boolean posicaoIncio) {
	...
	public Bloco addElemento(Aluno valor) {
	...
	private Bloco addElementoInicio(Aluno valor) {
	...
	private Bloco addElementoFim(Aluno valor) {
	...
	public void removeDuplicados() {
		...
		while (aux != null) {
			...
			while (atual != null) {
				if (atual.valor.matricula == aux.valor.matricula) {
